...
*
* Copyright (C) 2021 Víctor M. Batlle, Juan J. Gómez Rodríguez and Juan D. Tardós, University of Zaragoza.
*
 ...
 *
 * This class loads a sequence of the TUM-VI dataset stored in a given directory downloaded
 * from https://cvg.cit.tum.de/data/datasets/visual-inertial-dataset.
 *
 * It also computes (or loads if already processed) the left camera ground truth (Twc).
 */

#ifndef JJSLAM_TUMVILOADER_H
#define JJSLAM_TUMVILOADER_H
...
public:
     ...
     */
    TUMVILoader(std::string folderPath, std::string timesPath, std::string groundTruthPath);
